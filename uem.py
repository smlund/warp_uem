...
parser.add_argument('input_file', type=str, 
                    help='The path to the file containing the intial ' +
                      'conditions dictionary - specified with the ' +
...
parser.add_argument('-e','--extraction_field',  
                    ...
                    default=1.)
parser.add_argument('-m','--electron_per_macroparticle', 
...
weight = args.electrons_per_macroparticle # number of real particles per macro-particle 
